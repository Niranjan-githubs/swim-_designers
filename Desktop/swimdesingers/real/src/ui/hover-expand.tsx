      ...
      <div className="mx-auto flex w-fit gap-2 rounded-md pb-20 pt-10 md:gap-3">
        {reviews.slice(0, maxThumbnails).map((review, i) => (
          <div
            ...
            className={`group relative h-80 overflow-hidden rounded-2xl transition-all duration-200 ease-out ${
              selectedIndex === i ? "w-80" : "w-6 sm:w-8 md:w-12 xl:w-16"
            }`}
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="cursor-pointer overflow-hidden rounded-2xl bg-black max-w-3xl mx-4"
            >
